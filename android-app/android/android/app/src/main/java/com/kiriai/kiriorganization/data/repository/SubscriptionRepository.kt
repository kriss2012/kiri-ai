...
import com.kiriai.kiriorganization.data.models.AuthResponse
import com.kiriai.kiriorganization.data.models.OrderResponse
        ...
        return try {
            ...
            if (response.isSuccessful && body != null) {
                ...
                val message = if (errorBody?.trim()?.startsWith("{") == true) {
                    try { com.google.gson.Gson().fromJson(errorBody, com.kiriai.kiriorganization.data.models.GenericResponse::class.java).message } catch(e: Exception) { null }
                } else null
