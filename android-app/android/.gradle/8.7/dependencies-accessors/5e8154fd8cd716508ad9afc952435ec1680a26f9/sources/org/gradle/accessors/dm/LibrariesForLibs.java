...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final RazorpayLibraryAccessors laccForRazorpayLibraryAccessors = new RazorpayLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>razorpay</b>
     */
    public RazorpayLibraryAccessors getRazorpay() {
        return laccForRazorpayLibraryAccessors;
    }
    ...
    public static class MultiplatformLibraryAccessors extends SubDependencyFactory {
        private final MultiplatformMarkdownLibraryAccessors laccForMultiplatformMarkdownLibraryAccessors = new MultiplatformMarkdownLibraryAccessors(owner);

        public MultiplatformLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>multiplatform.markdown</b>
         */
        public MultiplatformMarkdownLibraryAccessors getMarkdown() {
            return laccForMultiplatformMarkdownLibraryAccessors;
        }

    }

    public static class MultiplatformMarkdownLibraryAccessors extends SubDependencyFactory {

        public MultiplatformMarkdownLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getRenderer() {
            return create("multiplatform.markdown.renderer");
        }
    ...
    public static class RazorpayLibraryAccessors extends SubDependencyFactory {

        public RazorpayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.razorpay:checkout</b> coordinates and
         * with version reference <b>razorpay</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("razorpay.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>markdown</b> with value <b>0.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>razorpay</b> with value <b>1.6.38</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRazorpay() { return getVersion("razorpay"); }
